...
enum DontBeTabBarItem: CaseIterable {
    ...
    var targetViewController: UIViewController? {
        ...
        case .notification: return NotificationViewController(viewModel: NotificationViewModel(networkProvider: NetworkService()))
        case .myPage: return MyPageViewController(viewModel: MyPageViewModel(networkProvider: NetworkService()))
        }
    }
}
